@push('styles')
    <style>
        #eventOverflow::-webkit-scrollbar {
            width: 4px;
            cursor: pointer;
        }

        #eventOverflow::-webkit-scrollbar-track {
            background-color: rgba(229, 231, 235, var(--bg-opacity));
            cursor: pointer;
        }

        #eventOverflow::-webkit-scrollbar-thumb {
            cursor: pointer;
...
<div
    ...
    <div
        ...
        <div
            ...
            @endif
            class="w-full h-full p-2 {{ $dayInMonth ? $isToday ? 'bg-yellow-50' : ' bg-white ' : 'bg-gray-100' }} flex flex-col">
            ...
            {{-- Events --}}
            <div class="p-2 my-2 flex-1 overflow-y-auto" id="eventOverflow">
