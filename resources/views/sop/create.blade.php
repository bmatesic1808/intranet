<x-app-layout>
    @section('breadcrumbs')
        {{ Breadcrumbs::render('sop-create') }}
    @endsection

    <div class="py-10 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('sop.store') }}" class="md:grid md:grid-cols-1 md:gap-6">
            @csrf
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <x-jet-input id="title" type="text" class="mt-1 block w-full" name="title" autocomplete="title" />
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <x-jet-input id="video_tutorial" type="text" class="mt-1 block w-full" name="video_tutorial" autocomplete="video_tutorial" />
                            <x-jet-input-error for="video_tutorial" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-6">
                            <x-jet-label for="overview" value="{{ __('Overview') }}" />
                            <x-jet-input id="overview" type="text" class="mt-1 block w-full" name="overview" autocomplete="overview" />
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <textarea name="procedure" id="procedure"></textarea>
                        </div>
                    </div>
                </div>
