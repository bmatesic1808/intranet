<div>
    <!-- We add team member via modal on current team, we don/t use Jetstream for roles and permissions, insted we use SpatiePermissions package  -->
                        ...
                        @foreach ($team->users->sortBy('name') as $user)
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-2 text-sm text-gray-600 capitalize underline">
