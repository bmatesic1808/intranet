<tr>
    ...
    <td class="px-6 py-4 whitespace-nowrap">
        <div class="flex justify-around">
            <div>
                <button wire:click="incrementCompetencyRating" type="button" class="focus:outline-none">
            ...
            <div>
                <button wire:click="decrementCompetencyRating" type="button" class="focus:outline-none">
