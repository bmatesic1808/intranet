<tr>
    ...
    <td class="px-6 py-4 whitespace-nowrap">
        <div class="flex justify-around">
            <div>
                <button wire:click="incrementProactivityRating" type="button" class="focus:outline-none">
            ...
            <div>
                <button wire:click="decrementProactivityRating" type="button" class="focus:outline-none">
