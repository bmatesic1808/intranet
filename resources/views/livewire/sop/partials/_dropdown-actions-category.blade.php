<x-jet-dropdown align="right" width="60">
    ...
    <x-slot name="content">
        <div class="w-52 z-50">
            <x-jet-dropdown-link class="cursor-pointer flex justify-between" wire:click="showEditModal({{ $category->id }})">
                <span>{{ __('Edit') }}</span>
            ...
            <hr>
            <x-jet-dropdown-link href="#" class="cursor-pointer flex justify-between" wire:click="showDestroyModal({{ $category->id }})">
                <span>{{ __('Delete') }}</span>
