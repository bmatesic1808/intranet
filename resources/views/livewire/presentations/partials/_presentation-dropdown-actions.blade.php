<div class="hidden sm:flex sm:items-center sm:ml-6">
    <div class="ml-3 absolute">
        <x-jet-dropdown align="right" width="60">
            ...
            <x-slot name="content">
                <div class="w-52 z-50">
                    <x-jet-dropdown-link wire:click="showEditModal({{ $presentation->id }})" class="cursor-pointer text-indigo-500">
                        {{ __('Quick edit') }}
                    </x-jet-dropdown-link>
                    <hr>

                    <x-jet-dropdown-link wire:click="showDestroyModal({{ $presentation->id }})" class="text-pink-500 cursor-pointer">
                        {{ __('Delete') }}
                    </x-jet-dropdown-link>
                </div>
            </x-slot>
